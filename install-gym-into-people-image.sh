...
#   ./install-gym-into-people-image.sh v2.5.1-beta29-jetpack62
#   ./install-gym-into-people-image.sh v2.5.1-beta29-jetpack62 cmucal/cabot-people

set -u

# tag this branch is meant to run against
DEFAULT_TAG=v2.5.1-beta29-jetpack62
